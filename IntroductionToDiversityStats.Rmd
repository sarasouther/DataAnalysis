---
title: "IntroToDiversity"
output: pdf_document
date: "2023-02-07"
---

```{r setup}
options(warn = -1)  # Set warn to -1 to suppress all warnings
...
#you have to adjust the code to port in these datasets!
setwd("/Users/sks379/Desktop/GraduateStudents/Stats and Lit Review Lessons/ClassX_DiversityStatistics")

#import species data
species_matrix <- read_csv("speciesmatrix.csv")

#import environmental (plot) data
env_matrix <- read_csv("envmatrix.csv")
```
...
control_pre <- select(control_pre, -c(Year, PlotN, Treatment, Treatment_status, ...1))
...
control_post <- select(control_post, -c(Year, PlotN, Treatment, Treatment_status, ...1))
...
treatment_pre <- select(treatment_pre, -c(Year, PlotN, Treatment, Treatment_status, ...1))
...
treatment_post <- select(treatment_post, -c(Year, PlotN, Treatment, Treatment_status, ...1))
...
setwd("/Users/sks379/Desktop/GraduateStudents/Stats and Lit Review Lessons/ClassX_DiversityStatistics")
arcticlocs <- read_csv("arcticlocs.csv")
